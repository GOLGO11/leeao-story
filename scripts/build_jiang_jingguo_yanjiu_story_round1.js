...
const BOOK = "蒋经国研究";
const SLUG = "jiang_jingguo_yanjiu";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJGYJ";
...
const selections = [
  ...
  {
    title: "穷老太太把蒋经国问得无法答覆",
    prefix: "014",
    paragraph: 24,
    start: "他有一次接见了一位六十多岁的穷苦老太太。",
    end: "遇到这种事真是不好办呀！”"
  },
  {
    title: "蒋经国给灾民钱被父亲制止",
  ...
  {
    title: "徐君虎骂退奉命来杀章亚若的学生",
    prefix: "016",
    paragraphs: [10, 11, 12, 13, 14, 15, 16]
  },
  {
    title: "蒋经国到了章亚若墓旁却不肯去看",
    prefix: "016",
    paragraph: 19
  },
  {
  ...
  },
  {
    title: "吴国桢逼桂永清撤出林班",
    prefix: "018",
    paragraphs: [73, 74, 75, 76],
    start: "桂永清草山受辱，当然不肯擅自罢休"
  },
  {
    title: "蒋经国亲自替儿子退还一枝铅笔",
    prefix: "019",
    paragraph: 41,
    start: "在每天放晚学回家时候",
    end: "由此可见蒋氏对他子女们的教育是多么的严格和不苟私。"
  },
  {
    title: "美国法官拒绝为蒋孝文受外交压力",
    prefix: "019",
    paragraph: 49
  }
];
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮只收可脱离人物生平与政治沿革独立复述、有起因、互动和结果，并用于揭示人物性格或说明道理的小故事；排除生平年表、政策与政争经过、材料作者的独立行程条目、史料论证链、名单、薄事实、传闻清单、纯评论和总库已有同核故事。",
    excludedByStandard,
    duplicateChecks: [
      "袁世凯杀应桂馨灭口、赵秉钧发牢骚后被毒死，已在《李敖札记》合并收录，本轮不重复。",
      "任显群庭上鞠躬说不敢上诉，已在《李敖访谈录1990-2018》收录，本轮不重复。",
      "新兵说妻子十个月后生产，已在《蒋介石研究》收录，本轮不重复。",
      "毛泽东与尼克松谈共同老友蒋介石，已在《蒋介石评传》收录，本轮不重复。",
      "曹冲冥婚等古代例证已在总库出现，本轮不重复。"
    ],
    proofreadDrops: [],
    proofreadTightened: [
      "饼干盒底藏贿款反被账簿揭穿",
