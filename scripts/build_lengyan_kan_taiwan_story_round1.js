...
const BOOK = "冷眼看台湾";
const SLUG = "lengyan_kan_taiwan";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "LYKTW";
const ORIGINAL_EXTRACTION_COUNT = 6;
...
const selections = [
  ...
  },
  {
    prefix: "015",
    paragraphs: [7, 8],
    title: "唐德刚记胡适家女客打麻将只留“清一色”",
    start: "唐德刚在《胡适杂忆》中记有一次",
    end: "只要颜色不同，就打掉再说！"
  },
  {
    prefix: "018",
  ...
  },
  {
    prefix: "032",
    paragraphs: [6, 7],
    title: "左舜生记周恩来以大哭逼三方收回文件",
    start: "左舜生《近三十年见闻杂记》记",
    end: "闭幕了。"
  },
  {
    prefix: "036",
    paragraphs: [13, 14, 15],
    title: "威尔·罗杰斯说祖先在岸上接“五月花号”"
  }
];
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮逐条复核故事闭合度、来源限定、原文边界与总库重复；只保留可脱离台湾党外人物评论、诉讼文书、书信和政治论战独立复述，有明确场景、行动、转折或结果，并用于揭示人物或说明道理的小故事；排除李敖自己的事件、第三方人物履历、政治与诉讼案件经过、证据链、薄事实、纯评论和总库已有同核故事。",
    excludedByStandard,
    duplicateChecks: [
      "破山和尚吃肉止屠与周世宗毁佛铸钱已在《李敖文存》收录，虞愿批评湘宫寺已在《北京法源寺》收录，本轮不重复。",
      "威尔森称美国利益与通用公司利益一致已在《李敖颠倒众生》收录，本轮不重复。",
      "周恩来指出马歇尔发表谈话时机偏向已在《李敖政论综艺集》收录，本轮不重复。",
      "甘地从律师席走到被告席已在《郑南榕研究》收录，本轮不重复。",
      "慕容霸摔掉门牙后被改名慕容缺已在《李敖文存二集》收录，本轮不重复。",
      "张白帆殉情时女方身亡、自己逃走已在《李敖演讲集》收录，本轮不重复。",
      "高玉树受蔡孟坚招抚、转而与国民党合作的同核故事已在《李敖演讲集》以 LAYJ038 收录，本轮不重复。"
    ],
    proofreadAdds: [],
    proofreadDrops: [],
    proofreadTightened: [],
    proofreadTitleAdjusted: [
      {
        id: "LYKTW002",
        from: "胡适家女客打麻将只留“清一色”",
        to: "唐德刚记胡适家女客打麻将只留“清一色”",
        reason: "标题补入原文转述来源；正文未改。"
      },
      {
        id: "LYKTW005",
        from: "周恩来以大哭逼三方收回文件",
        to: "左舜生记周恩来以大哭逼三方收回文件",
        reason: "标题补入原文转述来源；正文未改。"
      }
    ],
    proofreadContextCompleted: [
      {
        ...
        fromEnd: "到最后才知道是在纳税",
        toEnd: "他说在国内没有这种情形。",
        reason: "补足同一纳税笑谈的句尾与句号，不带入后续入伍轶事。"
      }
    ],
    proofreadNotes: [
      "提取轮原有六则全部保留，未新增、删除或收紧故事。",
      "LYKTW001 补足同一笑谈的句尾，LYKTW002 与 LYKTW005 标题补入转述来源。",
      "六则正文均为连续原文，没有改写、补句或跨越原文空缺拼接。",
      "施性忠一万五千元段落仍属案件陈述；高玉树受招抚一段与 LAYJ038 同核，均不补入。",
      "人物生平、党外往来、诉讼和书信证据链继续排除。"
    ],
    extractionNotes: [
      `候选扫描覆盖 ${sourceFiles().length} 个正文文件，机器候选 ${candidateCount()} 条。`,
      `提取轮保留 ${ORIGINAL_EXTRACTION_COUNT} 条，正文均能回到连续原文。`,
      "保留能独立说明人物品格或道理的寓言、笑谈和历史轶事；原文中的转述与出处限定一并保留。",
      "施性忠案件、郭国基与苏东启生平、党外人物交往、诉讼和书信材料不按故事拆分。",
