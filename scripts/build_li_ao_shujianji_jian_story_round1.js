...
const BOOK = "李敖书笺集";
const SLUG = "li_ao_shujianji_jian";
const ROUND = "story_round1";
const ID_PREFIX = "LASJJN";
const STATUS = "提取轮";
const OUT_DIR = path.join(ROOT, "data", "books", SLUG);
const NOTES_PATH = path.join(ROOT, "notes", "li_ao_shujianji_jian_story_round1.md");
const CANDIDATE_SCAN = "notes/li_ao_shujianji_jian_candidate_scan.tsv";
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "书信类提取轮只收文中被讲成一个可独立复述、并用来说明观点的小故事、笑话、掌故、文学故事或外部轶事；排除李敖自己的事件合集、现实案情链、人物履历、单句典故、比喻句和纯评论材料。",
    excludedByStandard: [
    ...
    extractionNotes: [
      ...
      "提取轮保留 4 条：科尔哈斯、河南煮皮鞋、康熙云林寺、牛顿取酒忘友。",
      "“致敬取消了”属于李敖自己的坐牢经历，且总表已有版本，本轮排除。",
      "河南皮鞋与科尔哈斯均属边界项：前者是外部转述，后者是文学故事梗概，校对轮可继续收紧。",
      "故事正文未改写，均按源文原句截取。"
    ],
