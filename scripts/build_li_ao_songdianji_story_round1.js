...
const BOOK = "李敖送电集";
const SLUG = "li_ao_songdianji";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "LASONG";
...
function main() {
  ...
  const manifest = {
    ...
    extractionNotes: [
      ...
      `校对轮复核后保留 ${rows.length} 条，较提取轮补入伏尔泰谈一小时胜美男 1 条。`,
      "正文均按源文原段或段内原文截取。",
