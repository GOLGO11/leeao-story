...
const BOOK = "蒋介石研究三集";
const SLUG = "jiang_jieshi_yanjiu_sanji";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJSYSJ";
const ORIGINAL_EXTRACTION_COUNT = 17;
const PROOFREAD_DROP_COUNT = 0;
const PROOFREAD_TIGHTENED_COUNT = 13;
...
const selections = [
  ...
  },
  {
    ...
    prefix: "004",
    paragraph: 187,
    start: "隋朝侯白《启颜录》中有一则笑话",
    end: "铛是平底锅，趁着锅热，再做一个饼也。"
  },
  {
    title: "杜根装死目中生蛆",
    prefix: "005",
  ...
  },
  {
    ...
    paragraph: 4,
    start: "23日下午7时许",
    end: "蒋公并强调敌人间谍无孔不入，我等必须随时随地提高警觉等语。"
  },
  {
    title: "蒋介石夜查译员房间",
    prefix: "008",
    paragraph: 9,
    end: "蒋委员长即在夜间10时后，也常来我房查核我之未出。"
  },
  {
    title: "蒋介石下楼查公事",
    prefix: "008",
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "只收李敖正文中讲成可独立复述、带人物行动或问答转折、并用来说明道理的小故事；排除战役经过、兵力部署、外交电文、史料考证、政治事件链、薄事实、纯评论和总库已有重复故事。",
    excludedByStandard,
    duplicateChecks: [
      "屈突通、尧君素两则已在总库《北京法源寺》合并完整收入，本书不重复。",
      "威尔基与宋美龄的故事核心已在总库《李敖政论综艺集》收入，本书不重复。",
      "蒋介石让全体起立表决张群一节已在总库《李敖有话说》收入，本书只取后续汤如炎半坐半立的不同情节。"
    ],
    proofreadNotes: [
