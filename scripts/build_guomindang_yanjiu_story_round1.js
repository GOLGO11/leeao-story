...
const BOOK = "国民党研究";
const SLUG = "guomindang_yanjiu";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "GMDYJ";
...
const selections = [
  {
    title: "老叟把“救亡复兴”听成“纣王复生”",
    prefix: "005",
    paragraph: 6,
    end: "盖误以救亡复兴为‘纣王复生’也。"
  },
  {
    title: "陈少白造假合影，李莲英再造假照解围",
    prefix: "006",
    paragraphs: [8, 9, 10, 11]
  },
  {
    title: "电车售票员利用金圆券贬值赚黄金",
    prefix: "007",
    paragraphs: [4, 5]
  },
  {
    title: "孙科请外国使节看春宫片挨父亲耳光",
    prefix: "011",
    paragraph: 23,
    start: "有一次法国公使到广州"
  },
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮只保留可脱离党史材料链、李敖亲历与整起政治案件独立复述，有明确人物、行动、反差或结果，并用于揭示人物或说明道理的小故事；排除李敖自己的事件、案件经过、调查报告、统计材料、政策沿革、薄事实、纯评论和总库已有同核故事。",
    excludedByStandard,
    duplicateChecks: [
      "尹俊嘉奖打手淫的哨兵、蒋经国问老兵为何不用保险套两则，已在《李敖回忆录》收录，本轮不重复。",
      "张汤审老鼠、孔雀为何东南飞、诸葛亮被说成音乐家等故事，已在总库收录，本轮不重复。",
      "《化石森林》的斯魁尔、《悲惨世界》的尚万近两则，已在《第73烈士》收录，本轮不重复。",
      "徐复观所讲‘神仙老虎狗’及范子文打蚊子影射沈之岳，已在总库收录，本轮不重复。",
      "都德《柏林之围》的朱屋大佐故事已在总库多次收录，本轮不重复。"
    ],
    proofreadDrops: [],
    proofreadTightened: [
      "老叟把‘救亡复兴’听成‘纣王复生’",
