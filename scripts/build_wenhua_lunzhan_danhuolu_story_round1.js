...
const BOOK = "文化论战丹火录";
const SLUG = "wenhua_lunzhan_danhuolu";
const ROUND = "story_round1";
const ID_PREFIX = "WHLZDH";
...
function main() {
  ...
  const manifest = {
    ...
    excludedByStandard: [
      "与《李敖全集》已收故事重复的孙悟空八卦炉开场",
      "文化论战 chronology、诉讼经过、期刊摘录和骂战材料",
      "李敖自己的遭遇和回嘴，如叶一凤约见、误认殷海光等",
      "公开新闻事件、通信问答、学术论证和讽刺性长比喻"
    ],
    proofreadNotes: [
      "本书校对后不保留故事。两条提取轮条目均来自论战引文，不是李敖自己展开叙述的故事。",
      "孙悟空八卦炉开场虽为李敖亲自借用的故事，但总表已在《李敖全集》收入同一故事，本书不重复收入。"
    ],
