...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "语录选本只保留未在总表出现、能独立复述的外部小故事、笑话、寓言、历史/文学掌故；排除李敖自身事件、人物履历、政治案情、材料链、单句格言、纯论证例子和同题重复故事。",
    excludedByStandard: [
    ...
    extractionNotes: [
      "候选扫描覆盖全书 31 个正文文件，自动候选 695 条；提取轮按故事性和总表去重后曾保留 13 条。",
      "校对轮删除 3 条边界材料，并收窄多条故事正文边界。",
      "最终新增项来自中国历史人物、人生拾零和纸上罗曼斯。",
      "大量强故事因已在前书入总表，本轮只在 notes 记录排除，不再重复入库。"
    ],
    proofreadNotes: [
      "删除唐太宗退兵前送礼、梁启超讲胡适书、堂吉诃德风车三条边界项。",
      "将伯夷叔齐、项羽、陶渊明、叶德辉、徐志摩、赌徒、王胄等条目裁到故事核心。",
      "保留项均为外部人物、笑话或掌故，不含李敖自身事件。"
    ],
