...
const BOOK = "蒋介石研究";
const SLUG = "jiang_jieshi_yanjiu";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJSYJ";
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮只收李敖正文中讲成可独立复述、带人物行动或问答转折、并用来说明道理的小故事；排除年谱考证、学历辨伪、日期校勘、档案引文、政治事件链、薄事实、纯评论和总库已有重复故事。",
    excludedByStandard,
    duplicateChecks: [
      "蒋批给马鸿逵银元后由蒋经国来电停发，已见总库 LASDJ006，本轮不重复。",
      "曹冲冥婚立后核心已见总库 DBXDCT060、LAYM005，本轮不重复。",
      "杨氏自经共葬与《元史》冥婚核心已见 LAYM005 的同一论证脉络，本轮不重复。"
    ],
    proofreadNotes: [
