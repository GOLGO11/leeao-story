...
const BOOK = "蒋介石的真面目";
const SLUG = "jiang_jieshi_de_zhenmianmu";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJSZMM";
...
const selections = [
  {
    title: "王正廷把蒋介石的电报翻过来看",
    prefix: "012",
    paragraph: 7,
    start: "阮毅成（阮当时为浙江省民政厅长）说",
    end: "他果然接受了。’"
  },
  {
    title: "吴稚晖识破蒋介石假让主席",
  ...
  },
  {
    ...
    prefix: "024",
    paragraph: 2,
    start: "中国笑话书《破涕录》里有一则笑话",
    end: "一时传为笑柄。”"
  },
  {
    title: "县长说不敢在蒋介石离婚书上批不准",
    prefix: "034",
    paragraph: 51,
    start: "假戏真做，为了完成离婚的法律手续",
    end: "彼此哈哈大笑。"
  },
  {
    title: "姚冶诚冒蒋纬国写信把自己召回",
    prefix: "034",
    paragraph: 62,
    start: "姚被蒋淡忘既久",
    end: "在广州住了些时，再回上海。"
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮只收可独立复述、有行动、对话或反转的小故事；排除历史论证、围城与选举经过、外交和谋杀指控、李敖个人论战、书信证据链、新闻记录、名单、薄事实、纯评论和总库已有重复故事。",
    excludedByStandard,
    duplicateChecks: [
      "已按王正廷倒看电报、吴稚晖假让主席、活佛挽联、离婚书批不准、姚冶诚冒名写信、威尔基失踪和考尔斯被抓伤等关键情节复查总库，未发现同核故事。",
      "蒋介石批银元与黄金后暗令停发的故事已在《李敖书牍集》收录，本轮不重复。",
      "康泽篇开头明廷误祭洪承畴的故事已在《蒋介石研究四集》收录，本轮不重复。"
    ],
    proofreadDrops: [],
    proofreadTightened: [
      "吴稚晖识破蒋介石假让主席",
