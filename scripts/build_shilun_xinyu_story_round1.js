...
const BOOK = "世论新语";
const SLUG = "shilun_xinyu";
const ROUND = "story_round1";
const ID_PREFIX = "SLXY";
...
function main() {
  ...
  const manifest = {
    ...
    proofreadDrops: [
      {
        title: "余登发徒步迎许信良",
        reason: "虽原文称“动人的故事”，但内容是当代政治人物事件与情义材料，容易混入事件合集，校对轮删除。"
      },
      {
        title: "四种法律制度笑话",
        reason: "这是概念分类式笑话，没有具体人物行动和故事转折，校对轮删除。"
      }
    ],
    excludedByStandard: [
      "李敖自己的坐牢、会面、访问被误记等亲历事件，除非原文转述为独立笑话或掌故，否则不收。",
      "余登发命案、施启扬警卫、苏秋镇立院表现、张群贪污实例等政治新闻、案情材料和人物履历，整体不作为故事条目。",
      "纯概念批评、报纸报道纠错、名单资料、口号新解和只有一句话的比喻，不收。",
      "同一段中只有论证功能的亚历山大戈登结等压缩例子，暂不单独列条。"
    ],
    extractionNotes: [
      "《世论新语》共 240 篇，主要是短政治评论；本轮从 60 个触发词候选中只收 13 条故事性较强的笑话、寓言、掌故和古典对话。",
      "当代政治人物段落只保留原文明说为故事、或具有完整寓言结构的少数条目，如施性忠三颗梨、余登发徒步迎许信良；校对轮可继续收紧。",
      "第 214 篇同段含多则典故，本轮拆成“君王后椎破玉连环”和“高洋抽刀斩乱丝”两条；亚历山大戈登结仅一语带过，暂不收。"
    ],
    proofreadNotes: [
      "校对轮从 13 条收缩为 11 条，删除当代政治事件材料和非叙事分类笑话。",
      "保留“施性忠三颗梨”，因为原文明确说是“讲了一个故事”，且文本本身是寓言式小故事，而非事件流水账。",
      "保留熊十力、胡适、程咬金、明太祖、君王后、高洋、司马懿、杨颙、艾子等掌故条目；它们都有具体人物、动作、对话或转折。"
    ],
