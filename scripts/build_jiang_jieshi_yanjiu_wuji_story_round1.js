...
const BOOK = "蒋介石研究五集";
const SLUG = "jiang_jieshi_yanjiu_wuji";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJSYWJ";
const ORIGINAL_EXTRACTION_COUNT = 11;
...
const selections = [
  ...
  {
    title: "冈村宁次说早知就在屋顶做记号",
    prefix: "012",
    paragraphs: [57, 58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69]
  },
  {
    title: "一件貂皮衣降了洪承畴",
    prefix: "015",
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮只收可独立复述、有行动和转折、并被李敖用来显出人物或道理的小故事；排除战役现场、加入组织等个人经历、条约沿革、判决书、演说、电文、名单、史料证据链、薄事实、纯评论和总库已有重复故事。",
    excludedByStandard,
    duplicateChecks: [
      "已按裤带、蒋百里预判、张子廉、孙铭九夜间搬家、冈村屋顶记号和洪承畴貂皮等关键情节复查总库，未发现同核故事。",
      "洪承畴误报殉国与明廷设祭已在《蒋介石研究四集》收录，本轮不重复；本轮只收清廷以貂皮衣劝降的另一则故事。",
      "孙铭九已在总库其他西安事变材料出现，但没有本轮“夜间搬家”这一情节。"
    ],
    proofreadDrops: ["孙铭九叫蒋介石起来抗日", "半夜小屋加入民族复兴社"],
    proofreadTightened: ["张学良因羊叔子之句不扣周恩来"],
    proofreadNotes: [
