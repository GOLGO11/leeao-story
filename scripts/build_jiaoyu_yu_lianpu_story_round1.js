...
const BOOK = "教育与脸谱";
const SLUG = "jiaoyu_yu_lianpu";
const ROUND = "story_round1";
const ID_PREFIX = "JYLP";
...
const selections = [
  {
    file: "010.蒋廷黻和他走的路.txt",
    title: "德国老人劝徐道邻别做官",
    paragraphs: [3, 4]
  },
  {
    file: "008.从李济的悲剧看中央研究院的几个黑暗面.txt",
    title: "李济课堂上当众发火",
    paragraphs: [27],
    start: "有一次他上课"
  },
  ...
  },
  {
    ...
    title: "郭沫若拓片到手抢风头",
    paragraphs: [52],
    start: "例如第三次安阳发掘出来的大龟四版",
    end: "使他们因资料开放而大大的失掉面子！"
  },
  {
    file: "011.工作最多的老头子——胡佛.txt",
    title: "胡佛枪林弹雨救小女孩",
    paragraphs: [4, 5, 6]
  },
  {
  ...
  },
  {
    file: "011.工作最多的老头子——胡佛.txt",
    title: "凯丝问女人能否做总统",
    paragraphs: [37, 38, 39, 40, 41, 42]
  },
  {
    file: "011.工作最多的老头子——胡佛.txt",
    title: "玛丽问胡佛钓什么鱼",
    paragraphs: [43, 44, 45, 46, 47, 48, 49]
  },
  {
    file: "010.蒋廷黻和他走的路.txt",
    title: "蒋廷黻说上帝造日本中国",
...
function main() {
  ...
  const manifest = {
    ...
    excludedByStandard: [
      "李敖自己的发难背景、读者来信、编辑室说明和私人书信往来",
      "教育制度、考试制度、台大文学院和中研院史语所的材料性案例",
      "长篇人物评传、学术史脉络、政策主张和资料目录",
      "只有一句机锋或比喻而缺少人物行动转折的段落"
    ],
    proofreadNotes: [
      "保留徐道邻、李济演讲/追猫、胡佛救人、帕德雷夫斯基、胡佛打字谎报年龄六条。",
      "删除偏资料封锁案例、一句机锋、通信问答和性格例子合集。"
    ],
