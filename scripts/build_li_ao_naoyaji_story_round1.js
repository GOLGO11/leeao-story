...
const BOOK = "李敖闹衙集";
const SLUG = "li_ao_naoyaji";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "LANYJ";
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮逐条复核叙事闭合度、来源限定、原文连续性与总库重复；只保留可脱离国家赔偿、禁书诉讼、行政陈情和法律文书独立复述，有明确场景、人物行动、转折或结果，并用于揭示人物或说明道理的小故事；排除李敖自己的诉讼事件、法律文书、案件时间线、证据链、薄事实和纯评论。",
    excludedByStandard,
    duplicateChecks: [
      "本书未形成可入选的第三方故事，故无新增故事需要与总库做同核保留。",
      "已对黄玉娇表态、一元赔偿、吴祺芳住屋与江鹏坚追问等叙事段落进行总库关键短语检索；它们均因自身事件或案件材料属性排除。"
    ],
    proofreadAdds: [],
    proofreadDrops: [],
    proofreadTightened: [],
    ...
    proofreadNotes: [
      ...
      "全部117个机器候选均已复核，其中15个五分以上、7个六分以上候选没有符合口径的第三方小故事。",
      "黄玉娇表态、一元国家赔偿与警员调职属于李敖自身经历；吴祺芳住屋案属于政治案件与公文论证链。",
      "单书CSV继续仅保留表头，TXT保持为空；总库与网页故事数不变。"
    ],
    extractionNotes: [
      `候选扫描覆盖 ${sourceFiles().length} 个正文文件，机器候选 ${candidateCount()} 条。`,
      `提取轮保留 ${ORIGINAL_EXTRACTION_COUNT} 条，正文均能回到连续原文。`,
      "高分候选与含‘故事、笑话、有一次、有一个、回忆、听说’的段落均已复核。",
      "诉状、答辩、判决、函件、法条论证、证据链和案件时间线不按故事拆分。",
      "李敖自己的诉讼与交涉经历不单独成条；本轮未发现符合口径的第三方小故事。"
    ],
