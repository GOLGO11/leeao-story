...
const BOOK = "蒋介石研究四集";
const SLUG = "jiang_jieshi_yanjiu_siji";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "JJSYSIJ";
...
const selections = [
  ...
  },
  {
    ...
    prefix: "011",
    paragraph: 42,
    start: "城破之前，李朗星衣冠整齐的提了一只大皮包去见康将军",
    end: "这位太守，就这样聪明的摇身一变杂在乱离的人群中，溜之乎也。"
  },
  {
    title: "罗列从忠烈祠活回来",
    prefix: "011",
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "只收李敖正文中讲成可独立复述、带人物行动或问答转折、并用来说明道理的小故事；排除身世考证、学校沿革、组织编制、外交文件、谋杀过程、政治事件链、薄事实、纯评论和总库已有重复故事。",
    excludedByStandard,
    duplicateChecks: [
      "已按韩瑊、郑绍发、端纳、李朗星、罗列、洪承畴和史鱼等人物与关键情节复查总库，未发现同核故事。",
      "端纳已在总库其他故事出现，但没有“Finished! It is finished!”这一情节，本轮保留。",
      "迷子瑕已在总库分桃故事出现，但与史鱼尸谏不是同一故事核心，本轮保留。"
    ],
    proofreadNotes: [
