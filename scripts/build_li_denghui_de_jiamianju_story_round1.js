...
function writeNotes(rows, validation, aggregate, manifest) {
  ...
  const lines = [
    ...
    `- 提取轮保留 0 条，校对轮仍保留 ${validation.count} 条；本书未发现符合“李敖讲出来的小故事、用来说明一个道理”且未入总库的条目。`,
...
function main() {
  ...
  const manifest = {
    ...
    proofreadNotes: [
      ...
      `提取轮保留 0 条；校对轮复核后仍保留 ${rows.length} 条。`,
      "010#P5 唐庄宗李天下已在总库以 LAWCEJ008 收入，不重复。",
      "003#P4-P5 是李敖自述办护照经历，020、021 章多为报告与证据链，均按口径排除。",
      "022#P6 的“故事”是政治论述概括，不是可独立复述的小故事。"
    ],
