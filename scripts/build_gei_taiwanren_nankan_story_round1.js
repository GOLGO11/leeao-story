...
const BOOK = "给台湾人难看";
const SLUG = "gei_taiwanren_nankan";
const ROUND = "story_round1";
const STATUS = "校对轮";
const ID_PREFIX = "GTWRNK";
...
const selections = [
  {
    prefix: "002",
    paragraph: 8,
    title: "沈之岳称读德文使彭明敏“合作”，彭后来逃往国外"
  },
  {
    prefix: "010",
    paragraph: 6,
    title: "张释之依法只罚惊马者，劝汉文帝不得加刑"
  },
  {
    prefix: "011",
    paragraph: 21,
    title: "高玉树自述受蒋介石训责后感激落泪",
    start: "早年拓宽敦化路时",
    end: "当时玉树感激得哭了出来。"
  },
  {
  ...
  },
  {
    prefix: "018",
    paragraph: 6,
    title: "《自立晚报》一则阅兵花絮使两人入狱五年"
  },
  {
    prefix: "022",
    paragraph: 6,
    title: "《逸史》里的周生喝茶、段公代他小便",
    end: "由你代表他小便。"
  },
  {
    prefix: "025",
    paragraphs: [9, 10, 11, 12, 13, 14],
    title: "徐萱记张建邦妻子隔窗大骂，要居浩然滚出去",
    start: "淡江英专从淡水真理街"
  },
  {
    prefix: "030",
  ...
  },
  {
    prefix: "035",
    paragraph: 6,
    title: "简雍以“淫具”反讽刘备凭酒器抓人",
    end: "（他有强奸女人的工具！）"
  },
  {
    prefix: "009",
    paragraph: 8,
    title: "凯撒虽承认妻子清白，仍以不容怀疑为由休妻",
    start: "还在莎士比亚出生前一千六百多年",
    end: "这一名言，出自布鲁塔克（Plutarch）《希腊罗马名人传》"
  }
];
...
function main() {
  ...
  const manifest = {
    ...
    criteria:
      "校对轮逐条复核叙事闭合度、来源限定、原文连续性与总库重复；只保留可脱离台湾政坛人物批评、报刊史、校产与遗产争议、关说案件和政治论战材料链独立复述，有明确场景、行动、转折或结果，并用于揭示人物或说明道理的小故事；排除李敖自己的事件、人物履历、政治与司法过程、财务证据链、薄事实、纯评论和总库已有同核故事。",
    excludedByStandard,
    duplicateChecks: [
      "孟子所说舜背父逃海边的同核故事，已在《上下古今谈》以SXGJT017收录，本轮不重复。",
      "西太后为太监李三顺逼罚守门人的同核故事，已在《中国命研究》以ZGMYJ011收录，本轮不重复。",
      "张释之依法只罚惊马者、周生喝茶让段公代为小便、石奢放父后自刎、简雍以淫具讽谏刘备及凯撒休妻等未在总库检出同核故事，予以保留。"
    ],
    proofreadAdds: [
      {
        id: "GTWRNK010",
        ...
        sourceIds: "009#P8",
        reason:
          "校对复核后认定为完整典故：有克罗狄亚男扮女装潜入、接受审判、凯撒承认妻子清白却仍离婚的连续过程；总库无同核故事。"
      }
    ],
    proofreadDrops: [],
    proofreadTightened: [],
    proofreadTitleAdjusted: [
      {
        id: "GTWRNK004",
        from: "柏杨与李子弋争吵时说出多少人收买我们",
        to: "柏杨与李子弋争吵时说“多少人收买我们”",
        reason: "给原话加引号并精简语序；正文未改。"
      },
      {
        id: "GTWRNK007",
        from: "徐萱记张建邦妻子隔窗大骂居浩然滚出去",
        to: "徐萱记张建邦妻子隔窗大骂，要居浩然滚出去",
        reason: "补出动作关系，避免标题连读歧义；正文未改。"
      }
    ],
    proofreadContextCompleted: [],
    proofreadNotes: [
      "提取轮原有九则全部保留，校对新增一则，未删除或收紧正文。",
      "十则正文均为连续原文，保留转述限定，没有改写、补句或跨段跳接。",
      "GTWRNK004、GTWRNK007 仅调整标题，既有GTWRNK001至GTWRNK009编号不变；新增故事追加为GTWRNK010。",
      "人物生平、政治案件、财务与书信材料链以及李敖自己的事件继续排除。"
    ],
    extractionNotes: [
      `候选扫描覆盖 ${sourceFiles().length} 个正文文件，机器候选 ${candidateCount()} 条。`,
      `提取轮保留 ${ORIGINAL_EXTRACTION_COUNT} 条，正文均能回到连续原文。`,
      "保留能独立说明人物品格、法治冲突或政治荒谬的现实轶事、历史掌故和讽谏故事；来源限定一并保留。",
      "人物批评、财务司法材料、报刊与校产全案、选举和关说过程不按事件拆分。",
