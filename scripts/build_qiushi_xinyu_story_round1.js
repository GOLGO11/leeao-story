...
const BOOK = "求是新语";
const SLUG = "qiushi_xinyu";
const ROUND = "story_round1";
const ID_PREFIX = "QSXY";
...
function main() {
  ...
  const manifest = {
    ...
    excludedByStandard: [
      "省议员表功、学生自打耳光、切腹承诺、周恩来学历纠错等新闻材料或政治事件材料。",
      "李敖在李府做客、光华商场、朋友修坟等亲历场景，虽有故事味，但按当前标准不收李敖自己的事件。",
      "卡萨尔斯、玛莎葛兰姆、梦露等人物概述，偏传记评论，不是独立小故事。",
      "陈鼓应、小和尚、李敖五叔等私人八卦和亲友轶事，容易混入杂项，暂不收。"
    ],
    proofreadDropCount: 3,
    proofreadDrops: [
      {
        title: "李玉阶遁走会穆虹讹传",
        reason: "后文已被澄清为讹传，且偏私人八卦；校对轮为保证故事准确性删除。"
      },
      {
        title: "乔治四世说参加滑铁卢",
        reason: "只有一句比较例证，缺少完整叙事动作与转折；校对轮删除。"
      },
      {
        title: "伊梅尔达只有一千零六十双鞋",
        reason: "属于当代新闻人物的单句回应，偏材料和 quote；校对轮删除，只保留由此引出的军阀笑话。"
      }
    ],
    extractionNotes: [
      "《求是新语》共 194 篇正文，另有目录与自序；本轮从 47 个触发词候选中先收 15 条。",
      "保留范围为明确讲出的笑话、掌故、寓言式故事和少数有转折的轶事；当代政治材料只在故事结构很清楚时暂收，校对轮可继续收紧。",
      "李玉阶遁走会穆虹在后文被李子弋澄清为讹传，标题已标明“讹传”，校对轮应重点复核是否保留。"
    ],
    proofreadNotes: [
      "校对轮从 15 条收缩为 12 条，删除讹传、单句例证和新闻式 quote。",
      "保留警察红包、周恩来答人才、比彻、刘宾雁、成舍我、富家作文、军阀姨太太等笑话或轶事，因为都有具体人物、动作、对话或转折。",
      "保留虞公借路、罗友祠门乞食、李自成隐姓蒋氏传说等古典故事或传说；其中罗友条剪去李敖评论尾巴，虞公条剪去政论引入。"
    ],
